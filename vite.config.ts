  ...
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: [
        ...
        "icons/icon-512.png",
        "wallet/pig.png",
        "wallet/pig-with-coin.png",
        "wallet/brown-wallet.png",
        "screenshots/wide-1200x630.png",
      ...
      manifest: {
        ...
        short_name: "Wallet",
        description:
          "A simple digital wallet for kids to manage allowance and make pretend payments.",
        theme_color: "#0ea5e9",
        ...
        screenshots: [
          ...
          {
            src: "/screenshots/narrow-540x720.png",
            sizes: "540x720",
            type: "image/png",
          },
        ],
      ...
      devOptions: {
        enabled: true, // enable SW during `vite dev` for easier local testing
        type: "module",
      },
    }),
  ],
